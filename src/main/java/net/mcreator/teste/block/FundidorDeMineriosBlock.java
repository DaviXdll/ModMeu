...
public class FundidorDeMineriosBlock extends TesteModElements.ModElement {
	@ObjectHolder("teste:fundidor_de_minerios")
	public static final Block block = null;
	public FundidorDeMineriosBlock(TesteModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fundidor_de_minerios");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Fundidor De Minerios");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new FundidorDeMineriosGUIGui.GuiContainerMod(id, inventory,
